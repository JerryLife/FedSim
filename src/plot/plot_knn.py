...
if __name__ == '__main__':
    ...
    #          algorithms=['FedSim', 'Top1Sim', 'AvgSim', 'FeatureSim', 'Solo'],
    #          ks=[5, 10, 20, 30, 40, 50], save_path="fig/song_knn.png")
